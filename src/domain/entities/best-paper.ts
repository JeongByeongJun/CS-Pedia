...
export const AwardTypeEnum = z.enum([
  ...
  "best_student_paper",
  "best_student_paper_runner_up",
  "best_paper_early_career",
  "best_paper_applied_ds",
  "computational_modeling_prize",
  "distinguished_paper",
  "outstanding_paper",
  "honorable_mention",
  "test_of_time",
...
export const AWARD_TYPE_LABELS: Record<z.infer<typeof AwardTypeEnum>, string> = {
  ...
  best_student_paper_runner_up: "Best Student Paper Award Runner-Up",
  best_paper_early_career: "Best Paper Award (Early Career)",
  best_paper_applied_ds: "Best Paper Award (Applied DS Track)",
  computational_modeling_prize: "Computational Modeling Prize",
